<html>
            ...
            <div class="scroll-sidebar" >
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="#"onclick="openPage('home1.html')" aria-expanded="false"><i class="fa fa-tables"></i><span class="hide-menu">Store</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="#"onclick="openPage('Table.php')" aria-expanded="false"><i class="fa fa-tables"></i><span class="hide-menu">Tables</span></a>
                        </li>
 ...
 <footer class="footer text-center" style="position:absolute; bottom:0; width:100%; height: 50px;"><p style="margin-left: 200px;">© 2018 KFC Admin Page by error 404</p></footer>
 </html>
